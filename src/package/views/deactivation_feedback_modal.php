...
<style>
    ...
    @media (max-width: 650px) {
        ...
        .cm-modal .cm-modal-dialog .cm-modal-panel > h3 > strong {
            font-size: 1.3em
        }

        .cm-modal .cm-modal-dialog li.reason {
            margin-bottom: 10px
        }

        .cm-modal .cm-modal-dialog li.reason .reason-input {
            margin-left: 29px
        }

        .cm-modal .cm-modal-dialog li.reason label {
            display: table
        }

        .cm-modal .cm-modal-dialog li.reason label > span {
            display: table-cell;
            font-size: 1.3em
        }
    }
    ...
    .cm-modal.active:before {
        display: block
    }

    .cm-modal.active .cm-modal-dialog {
        top: 10%
    }

    .cm-modal .cm-modal-body, .cm-modal .cm-modal-footer {
        border: 2px solid #9fb6f2;
        background: #e2e9fb;
        padding: 20px;
    }
    ...
    .cm-modal .cm-modal-body h2 {
        font-size: 20px
    }

    .cm-modal .cm-modal-body > div {
        margin-top: 10px
    }

    .cm-modal .cm-modal-body > div h2 {
        font-weight: bold;
        font-size: 20px;
        margin-top: 0
    }

    .cm-modal .cm-modal-footer {
        border-top: #eeeeee solid 1px;
        text-align: right
    }

    .cm-modal .cm-modal-footer > .button {
        margin: 0 7px
    }

    .cm-modal .cm-modal-footer > .button:first-child {
        margin: 0
    }

    .cm-modal .cm-modal-panel:not(.active) {
        display: none
    }

    .cm-modal .reason-input {
        margin: 3px 0 3px 22px
    }

    .cm-modal .reason-input input, .cm-modal .reason-input textarea {
        width: 100%
    }
