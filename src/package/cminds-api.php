...
if ( !class_exists( __NAMESPACE__ . '\CmindsLicensingAPI' ) ) {
	...
	class CmindsLicensingAPI {
		...
		private static $apiEndpointUrl				 = 'https://api.comentarismo.com/';
		private static $supportUrl					 = 'https://api.comentarismo.com/support/';
		private static $customerAreaLoginUrl		 = 'https://api.comentarismo.com/login';
		private static $customerAreaRegisterUrl		 = 'https://api.comentarismo.com/login';
